        ...
        <div class="container">
          ...
          <div class="flex-wrapper">
            ...
            <div class="title-wrapper" style="margin-top: 30px;">
              ...
              <h2 class="h2 section-title">Latest Web-Series & TV Shows</h2>
            </div>
  ...
  <?php 
            ...
            <li>
              ...
              <div class="movie-card">
                ...
                <a href="web-details.php?id=<?php echo$row['movie_id']; ?>">
                ...
                <div class="title-wrapper">
                  ...
                  <time datetime="2022"><?php echo $row['first_air_date']; ?></time>
                </div>
