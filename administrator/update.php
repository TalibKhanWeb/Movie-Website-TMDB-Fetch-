...
<form action="updatevalidation.php" method="post" id="add_form">
	<div class="container">
		 <?php 
...
<div class="row mb-3">
 ...
 <div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
  ...
  <div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
    <input type="text" class="form-control" name="release_date" placeholder="release_date" value="<?php echo $row['release_date']; ?>">
  </div>
<div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
    <input type="text" class="form-control" name="revenue" placeholder="revenue" value="<?php echo $row['revenue']; ?>">
  </div>
  <div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
    <input type="text" class="form-control" name="runtime" placeholder="runtime" value="<?php echo $row['runtime']; ?>">
  </div>
...
<div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
    <input type="text" class="form-control" name="budget" placeholder="budget" value="<?php echo $row['budget']; ?>">
  </div>
...
<div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
  ...
  <div class="col-12 col-sm-6 col-md-3 col-xl-2 mb-3">
    ...
    <input type="text" class="form-control" name="production_countries" placeholder="production_countries" value="<?php echo$row['production_countries']?>">
...
<br>
      <input type="text" name="dloadlable[]" placeholder="Label" value="<?php echo$ro['lable'] ?>" class="form-control">
    </div>
        <div class="col-md-6 mb-3">
